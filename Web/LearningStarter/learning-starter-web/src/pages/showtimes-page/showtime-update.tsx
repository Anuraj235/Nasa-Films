import { Button, Container, Flex, Header, NumberInput, Space, TextInput, } from "@mantine/core"
import { useEffect, useState } from "react"
import { ApiResponse, ShowtimesCreateUpdateDto, ShowtimesGetDto } from "../../constants/types"
...
export const ShowtimeUpdate =() =>{
    ...
    useEffect (()=>{
        ...
        async function fetchShowtime(){
            const response = await api.get<ApiResponse<ShowtimesGetDto>>(`/api/showtimes/${id}`); 
            ...
            if (response.data.data)
{
    ...
    const submitShowtime = async (values: ShowtimesCreateUpdateDto) => {
      const response = await api.put<ApiResponse<ShowtimesGetDto>> (`/api/showtimes/${id}`, values) ;
